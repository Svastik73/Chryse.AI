#SAR colorization using trained CNN
...
def load_and_preprocess_image(image_path, target_size):
    ...
    image = cv2.imread(image_path, cv2.IMREAD_GRAYSCALE)  # i took the grayscale
...
def colorize_sar_image(image_path, model_path, output_path):
    ...
    colorized_image = model.predict(image)[0]  
...
model_path = r"C:\Users\Svastik Kanwar\Documents\Colorize\colorization_model_combined.h5"  
